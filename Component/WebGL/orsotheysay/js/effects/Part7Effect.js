var Part7Effect = function ( camera, renderer ) {
	...
	particle = new THREE.Particle( loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/sun.png' ) );
	particle.scale.x = particle.scale.y = 6;
	scene1.addObject( particle );

	particle = new THREE.Particle( loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/Components/WebGL/orsotheysay/files/textures/sun2.png' ) );
	...
	material = loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/asteroid.png' );
