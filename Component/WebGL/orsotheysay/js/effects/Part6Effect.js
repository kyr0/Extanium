var Part6Effect = function ( camera, renderer ) {
	...
	greetings = ["Ate Bit", "ASD", "CNCD", "DNA", "Evoflash", "Fairlight", "Farbrausch", "Orange"];
	...
	material2 = loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/line_planet.png' );
