var Part3Effect = function ( camera, renderer ) {
	...
	particle = new THREE.Particle( loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/nova.png' ) );
	scene.addObject( particle );

	material = loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/nova_particle.png' );
	material2 = loadImage( new THREE.ParticleBitmapMaterial(), '../Component/WebGL/orsotheysay/files/textures/galaxy32.png' );
